package org.example.appсontrol.database;
...
public class DataBase {
    ...
    // метод, возвращающий ссылку на бд
    ...
    public static int countRowsWithCondition(String tableName, String fieldName, Object fieldValue) {
        ...
        try (Connection conn = DriverManager.getConnection(DATABASE_URL)) {
            ...
            // устанавливаем значение в зависимости от переданных данных
    ...
    public static List<String> columnToList(String tableName, String columnName) {
        ...
        try (Connection conn = DriverManager.getConnection(DataBase.getDatabaseUrl())) {
            ...
            // добавляем в массив, пока есть элементы
    ...
    public static Object getCellValueByTwoConditions(String tableName, String targetColumn, String column1,
        ...
        try (Connection connection = DriverManager.getConnection(DataBase.getDatabaseUrl())) {
            ...
            if (rs.next()) {
                ...
                // определяем тип данных и возвращаем значение ячейки
                switch (columnType) {
                    case Types.INTEGER:
    ...
    // метод для извлечения значения ячейки по одному условию
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery)) {
                ...
                try (ResultSet resultSet = preparedStatement.executeQuery()) {
                    if (resultSet.next()) {
                        ...
                        // определяем тип данных и возвращаем значение
                        switch (columnType) {
                            case Types.INTEGER:
    ...
    // метод для получения последнего добавленного id
    public static int getLastRowId(String tableName) {
        ...
        try (Connection connection = DriverManager.getConnection(DATABASE_URL)) {
            try (Statement stmt = connection.createStatement();
                 ...
                 // тк id генерируются автоматически, последний = максимальный
